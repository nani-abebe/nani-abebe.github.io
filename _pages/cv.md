...
<a class="btn btn-sm z-depth-0 cv-pdf" href="{{ '/assets/pdf/cv.pdf' | relative_url }}" target="_blank" rel="noopener"><i class="fa-solid fa-file-pdf"></i> download pdf</a>
